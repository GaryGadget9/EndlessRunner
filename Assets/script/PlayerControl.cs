...
public class PlayerControl : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        StartCoroutine("MakeBox", 0.25F);                           //used for creating new platforms
    ...
    void Update()
    {
        ...
        newBoxLocation.x = this.transform.position.x;               //used to create new platforms and where to place them
